...
using System.Collections.Generic; //DH
...
namespace TagReader.RFIDReader
{
    public class ReaderSettings
    {
        ...
        public List<ushort> HopChannelList = new List<ushort>();

        public ReaderSettings()
        {
           Ip = "192.168.0.20"; // default: 192.168.1.2
            ...
            */
            ChannelIndex = 8;
            HopChannelList.Add(1);
            HopChannelList.Add(2);
            ...
            */
            ...
            AntennaId = new[] { true, true, true, true };
